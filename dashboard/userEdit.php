...
<label for="phone">Phone</label>
      <input type="phone" id="phone" value="<?php echo $row['phone']; ?>" name="phone" required>

      <label for="birthday">birthday</label>
      <input type="birthday" id="birthday" value="<?php echo $row['birthday']; ?>" name="birthday" required>
